...
| TTS名                       | 精度 | 生成速度 | 特徴 | 
| ---                         | -- |--- |--- |
| [Kokoro](https://github.com/TeamSOBITS/sobits_tts/blob/jazzy-devel/README_detail.ja.md#kokoro-tts)                      | ☆☆☆☆  | ☆☆☆☆ | 英語・日本語などに対応 |
| [Coqui](https://github.com/TeamSOBITS/sobits_tts/blob/jazzy-devel/README_detail.ja.md#coqui-tts)                       | ☆☆☆☆   | ☆☆☆☆ | 英語のみに対応 |
| [Piper](https://github.com/TeamSOBITS/sobits_tts/blob/jazzy-devel/README_detail.ja.md#piper-tts)                     | ☆☆☆     | ☆☆☆☆☆ | 日本語以外の多言語対応，超軽量・CPUでも高速動作　|
| [Supertonic](https://github.com/TeamSOBITS/sobits_tts/blob/jazzy-devel/README_detail.ja.md#supertonic-tts)                  | ☆☆☆     | ☆☆☆☆☆ | 英語・日本語など31言語に対応，非常に軽量　|
| [Voicevox](https://github.com/TeamSOBITS/sobits_tts/blob/jazzy-devel/README_detail.ja.md#voicevox-tts)                    | ☆☆☆☆   | ☆☆☆☆| 日本語のみに対応．ずんだもんで発話可能　|
...
| playback_speed | 生成後の音声に対する再生速度倍率（0.5〜2.0）．使用しているTTSバックエンドに関わらずピッチは保持される．`ros2 param set` で稼働中に動的変更可能で，次の発話から反映される． | `1.0` |
...
> [!NOTE]
> `playback_speed` は，生成済みの音声に対する後処理（PyAVの`atempo`フィルタ）として適用されるため，各バックエンド固有の速度パラメータ（例: `supertonic.speed`、`voicevox_speed_scale`）とは独立して動作します．`tts_name` に何を選択していても同じ挙動になります．
