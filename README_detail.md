...
[JA](README_detail.ja.md) | [EN](README_detail.md)
...
<p align="right">(<a href="#kokoro-top">Back to Kokoro TTS Top</a>)</p>
...
<p align="right">(<a href="#openpico-top">Back to OpenPico Top</a>)</p>
...
<p align="right">(<a href="#coqui-top">Back to Coqui TTS Top</a>)</p>
...
<p align="right">(<a href="#parler-top">Back to Parler TTS Top</a>)</p>
...
[Supertonic TTS](https://github.com/supertone-inc/supertonic) is a lightning-fast, on-device text-to-speech system designed for extreme performance with minimal computational overhead. Powered by ONNX Runtime, it runs entirely on your device and is even compatible with Raspberry Pi. This package currently uses Supertonic-3 (31 languages) and runs CPU-only.
